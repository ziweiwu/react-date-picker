...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/ziweiwu/react-date-picker/master/docs/images/calendar-open.png"
    alt="A date field labelled 'Select a date' showing 08/20/2026, with the calendar open below it on August 2026 and the 20th selected in blue"
    width="380"
  />
</p>
...
Screenshots are generated by `npm run screenshots`, which freezes the browser
clock so the images stay identical between runs.
